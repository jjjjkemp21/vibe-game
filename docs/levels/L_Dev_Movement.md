...
Owner: level-designer. Status: v1 (2026-09-23), previews checked; not yet built in the editor.
...
|---|---|---|---|
| T0 Start + speed lane | (0, 0) | 20 m lane with a line every 1 m (red every 5 m); 1 m crate for scale; PlayerStart at (-200, 0) | Walk 20 m in 5.7 s, sprint 3.3 s, crouch 11.1 s, prone 22.2 s |
| T1 Crawl gaps | (0, 800) | three 3 m tunnels, 1.4 m wide, clearance **59 / 60 / 61 cm** | Prone passes all three; crouch and stand blocked; standing up inside is blocked and queued, then completes on exit |
...
All clearances were measured in the preview (a ray from the floor up, against colliding geometry): 59.0, 60.0, 61.0,
181.4, 185.4, 111.4 and 115.4 cm, all PASS.
...
## Performance
77 primitives, 2 props, 4 lights, about 40 markers and labels. Trivial.
