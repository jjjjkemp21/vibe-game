...
- `Interaction/LureInteractable.h` ULureInteractable | things the player can use with the Interact key (T-010: sell points; later NPCs, b...
- `Interaction/LureInteractionComponent.h` ULureInteractionComponent | the player's Interact key (T-010).
...
- `Progression/LureCoolerComponent.h` ULureCoolerComponent | the player's cooler (T-010). Rules: docs/specs/progression-rules.md.
- `Progression/LureProgressionComponent.h` ULureProgressionComponent | money, XP and levels (T-010). Rules: docs/specs/progression-rules.md.
...
- `Progression/LureSellPoint.h` ALureSellPoint | a place to sell the cooler (T-010).
- `VibeGame.h`
