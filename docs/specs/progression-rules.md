...
## Placeholder UI
- Plain white text, top-left, drawn by `ALureHUD::DrawHUD` (same path as the fishing text; the debug-canvas hook was dropped after the T-006/T-010 playtest, B2): `Money 120   Level 3 (XP 40/110)   Cooler 5/8`, and near a sell point `[E] Sell 5 fish (230 coins)`. Off with `bShowPlaceholderText=False`. T-011 replaces it (`ULureProgressionComponent::GetStatusText`, `ULureInteractionComponent::GetPromptText`).
