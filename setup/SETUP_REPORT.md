...
## Pending handoff
>>> COWORK: Restart Claude Code to load the blender MCP server: type /exit, run tools\open-claude.cmd --continue, approve the "blender" MCP server if asked, then type: continue setup at K4
